...
int main()
{
    ...
    */
    ...
    answer = "The output of this is the modular value, or the remainder of the division of two numbers. This output will be the remainder of 10 numbers with a range of 0 to 4 (the range of numbers with the remainder 5) " ; // 2. Write your answer to Q2 in between " "
    ...
    answer = "The output of this will be the modular 5 with 3 then added to each of those values. This produces numbers ranging 3 to 7" ; // 3. Write your answer to Q3 in between " "
    ...
    answer = "When you remove srand(time(NULL)), the output is the same number because you are signing the same seed" ; // 4. Write your answer to Q4 in between " "
